...
#         info_label.configure(text="Created successfully")
        
#     except pyodbc.Error as ex:
#         print('Error create database',ex)    
#         info_label.configure(text="Error create database")
        

# create_button = customtkinter.CTkButton(app,text="Create DB",
#                                        command=create_db,
#                                        fg_color="green")
...
# connect_button = customtkinter.CTkButton(app,text="Connect DB",
#                                        command=connect_db,
#                                        fg_color="blue")
